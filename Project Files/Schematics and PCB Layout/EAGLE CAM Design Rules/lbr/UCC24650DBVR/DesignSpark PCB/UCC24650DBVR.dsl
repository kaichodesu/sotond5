...
(library Library_1
	...
	(compDef "UCC24650DBVR" (originalName "UCC24650DBVR") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "ENS") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "N.C.") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "WAKE") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.ti.com/lit/gpn/ucc24650")
		(attr "Height" "1.45 mm")
	)
